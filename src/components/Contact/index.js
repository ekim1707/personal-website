...
export const Contact = () => {
  ...
  const validateForm = ({ first_name, last_name, email, inquiry }) => {
    let formErrors = [first_name, last_name, email, inquiry].filter(
      ...
      emailjs
        ...
        .then(
          ...
          (error) => {
            ...
            window.alert(
              "Sorry, message could not be sent due to some type of error."
            );
          }
        );
    }
  ...
  const { first_name, last_name, email, inquiry_type, inquiry } = formData;
  ...
  return (
    <div
      onClick={selectIsOpen ? () => setSelectIsOpen(false) : ""}
      ...
      <form className="formContainer">
        <div className="headerInputRow">
          <div className="inputContainer">
            <InputField
              ...
              style={
                clickCount > 0 && first_name.length === 0
                  ? {
                  ...
                  : clickCount > 0 && first_name.length !== 0
                  ? {
                      borderTop: "2px solid #0080005b",
                      borderBottom: "2px solid #0080005b",
                    }
                  : {}
              }
            />
          ...
          <div className="inputContainer">
            <InputField
              ...
              iconName="username_main_4"
              style={
                clickCount > 0 && last_name.length === 0
                  ? {
                      borderTop: "2px solid #ff0000",
                      borderBottom: "2px solid #ff0000",
                    }
            ...
            {!selectIsOpen && (
              <InputField
                ...
                style={
                  selectIsOpen
                    ? {
                        borderTop: "2px solid #c900178a",
                        borderBottom: "2px solid #c900178a",
                      }
                    : clickCount > 0
                    ? {
                        borderTop: "2px solid #0080005b",
              ...
              <React.Fragment>
                <InputField
                  ...
                  style={
                    selectIsOpen
                      ? {
                          borderTop: "2px solid #68ace5",
                          borderBottom: "2px solid #68ace5",
                        }
                      : clickCount > 0
                      ? {
                          borderTop: "2px solid #0080005b",
                ...
                <ul className="selectList">
                  {content.INQUIRY_TYPES.map((type, i) => (
                    <li
                      onClick={(e) => handleInputChange(e, type)}
                      key={i}
                      style={inquiry_type === type ? { color: "#68ace5" } : {}}
                    >
                      {type}
                    </li>
                  ))}
        ...
        <div className="textAreaContainer">
          <TextArea
            ...
            value={inquiry}
            style={
              clickCount > 0 && inquiry.length < 1
                ? {
                    borderTop: "2px solid #ff0000",
                    borderBottom: "2px solid #ff0000",
                  }
                : clickCount > 0 && inquiry.length > 0
                ? {
                    borderTop: "2px solid #0080005b",
                    borderBottom: "2px solid #0080005b",
                  }
